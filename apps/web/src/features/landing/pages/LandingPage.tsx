...
export default function LandingPage() {
    return (
        <>
            <nav className="flex items-center justify-between w-full max-w-[1280px] px-[52px] py-9 mx-auto">
                ...
                <ul className="flex items-center gap-6">
                    <li>
                        <Link
                            to="/"
                            className="font-medium text-lg leading-[22.5px]"
                        >
                            Home
                        </Link>
                    </li>
            ...
            <header className="relative w-full max-w-[1280px] px-[52px] mx-auto">
                <div className="flex flex-col rounded-t-[52px] h-[999px] bg-[linear-gradient(180deg,#F7F9FF_0%,rgba(247,249,255,0.01)_100%)]">
                    <div className="flex flex-col gap-[54px] items-center mt-20">
                        <div className="flex flex-col gap-[30px] items-center">
                            ...
                            <p className="w-[559px] font-medium leading-[28px] text-heyhao-secondary text-center">
                                Be Part of or Build Communities That Empower You
                                to Network, Learn, and Achieve Career Milestones
                                Faster
                            </p>
                        </div>
                    ...
                    <div className="relative mx-auto mt-[52px] -mb-[330px] pt-[64px]">
                        ...
                        />
                        <span className="w-[225px] h-[276px] rounded-3xl bg-[#1B2340]/[20%] absolute top-[125px] left-[49px] z-30 blur-[60px]" />
                        <span className="left-[-20px] bg-[#1B3266]/[5%] absolute right-[-20px] top-[64px] h-[380px] z-10 blur-[50px]" />
                        <img
                        ...
                        />
                        <span className="w-[345px] h-[287px] rounded-3xl bg-[#1B2340]/[20%] absolute bottom-[88px] right-[-21px] z-30 blur-[60px]" />
                    </div>
                </div>
            </header>
            <section
                        ...
                        <div className="slide-right flex gap-8 flex-nowrap pr-8">
                            <div className="card bg-white/[9%] flex flex-col w-[430px] shrink-0 rounded-3xl p-5 gap-4 text-white">
                                ...
                                <p className="font-semibold text-lg leading-8">
                                    "It’s more than just a messaging app—it’s my
                                    go-to tool for staying in touch with
